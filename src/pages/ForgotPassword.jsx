    ...
    <section>
      ...
      <div className="flex justify-center items-center flex-wrap py-12 px-6 max-w-6xl mx-auto">
        ...
        <div className="md:w-[67%] lg:w-[40%] w-full lg:ml-20">
          ...
          <button type = "submit" className='w-full bg-blue-600 py-3 px-6 rounded shadow-md text-white hover:bg-blue-700 hover:shadow-lg transition duration-150 ease-in-out uppercase text-sm font-medium active:bg-blue-800'>Send Reset Password</button>
