        ...
        <div className="md:w-[67%] lg:w-[40%] w-full lg:ml-20">
          ...
          <input 
           ...
           <div className='flex justify-between py-6 mb-6 text-sm sm:text-lg'>
            <p>Have an account?
              <Link to = "/login" className='text-red-600 ml-1'>Sign in</Link>
            </p>
            <p>
          ...
          <button type = "submit" className='w-full bg-blue-600 py-3 px-6 rounded shadow-md text-white hover:bg-blue-700 hover:shadow-lg transition duration-150 ease-in-out uppercase text-sm font-medium active:bg-blue-800'>Sign Up</button>
